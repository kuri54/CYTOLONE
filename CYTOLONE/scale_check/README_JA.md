...
- モード
    ...
    - **Semi-Auto** タブ:
        ...
        - 推定後はスライダーで微調整できます。
        - 両画像にカーソル追従ルーペを表示します。ルーペは確認用であり、
          クリック対象は元画像のままなので、受け取る座標は元画像座標からずれません。

- Semi-Auto 操作手順
    1. 基準画像（Reference Image）を選択
    2. 10倍対物レンズの入力画像を撮影またはアップロード
    3. 基準画像で約4〜6倍のルーペと中央固定十字を使い、**扁平上皮核の中心**を1点クリック
    4. 入力画像でもルーペと中央固定十字を使い、**扁平上皮核の中心**を1点クリック
    5. クリック点と採用マスクが同時に分かる核抽出プレビューを確認
    6. 抽出失敗または低信頼度の場合は核径を返さず、別の核を再クリック
